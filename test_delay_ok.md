...
Konfiguration: Piper TTS, SILENCE_FR=15, vad_filter=True, no_speech_threshold=0.7
Ergebnis: 6 Segmente, 0 Skips, 0 Halluzinationen, Anruf-Ende nach 60s (Dial-Timeout)

| # | Deutsch (gesprochen)                              | Italienisch (übersetzt)                              | STT   | TRL   | TTS   | Σ      |
|---|---------------------------------------------------|------------------------------------------------------|-------|-------|-------|--------|
